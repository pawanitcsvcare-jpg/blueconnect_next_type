...
import LogoImage from '../assets/images/BlueConnectsLogo.png';
                ...
                <div id="sidebar-menu">
                    <ul className="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul className="sub-menu mm-collapse" aria-expanded="false" style={{display:'none'}}>
                                {["MSISDN Snapshot","Activation – Billing","Deactivation","PortOut","PortIn","Usage Reports","Billng Usage Reports","MRC Subscriber","Vendor MRC Subscriber","Device Notification","PortOut Notification","Threshold Notification","NetIP Report","NetIP Report Summary","NetIP Account Reload"].map((label) => (
                                    <li key={label}><Link href="#"><span className="sidebar-under-icons"><i className="ri-focus-line"></i></span> {label}</Link></li>
                                ))}
                            </ul>
                        </li>
